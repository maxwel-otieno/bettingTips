...
<body style="background-color: white; color: black;">
    ...
    <div class="container mt-5">
        ...
        <h4>Last updated: November 03, 2021</h4><br>
        ...
        Interpretation
        The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p><br>

        <h1 style="font-weight: 300;">Definitions</h1>
        <p>For the purposes of this Privacy Policy:</p>

        <p>Account means a unique account created for You to access our Service or parts of our Service.</p>

        <p><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to bet3ways.</p>
        ...
        <p><b>Website</b> refers to bet3ways, accessible from www.bet3ways.com</p>

        <p><b>You</b> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p><br>
        ...
        By email: bet3ways@outlook.com</p>
    </div>
</body>
</html>