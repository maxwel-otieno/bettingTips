          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">local_offer</i> Tracked from <?php echo $site_name;?>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category" id="myP"></p>
                  <script>
                      const d = new Date();
                      console.log(d.getFullYear());

                      const months = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
                      // document.getElementById('myP').innerHTML = "New visits on "+d.getDate()+" "+months[d.getMonth()]+", "+d.getFullYear();
                      document.getElementById('myP').innerHTML = "As at "+d.getDate()+" "+months[d.getMonth()]+", "+d.getFullYear();
                  </script>
                </div>
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        foreach($row_notif as $notif){
                          $date = date("d M", strtotime($notif->time));
                            $time = date("h:i a", strtotime( $notif->time));
                            if($notif->userID != 'unknown'){
                              $username = fetchDB('db_user','id',$notif->userID)->username;
                            }else{
                                $username = 'Unknown';
                            }?>
                      <tr>
                        ...
                        <td><?php echo $notif->activity_desc;?></td>
